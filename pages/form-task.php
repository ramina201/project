    ...
    <div class="container container--with-sidebar">
      ...
      <div class="content">
        ...
        <main class="content__main">
          ...
          <form class="form" action="../php/addTask.php" method="post" autocomplete="off" enctype="multipart/form-data">
            <div class="form__row">
            ...
            <div class="form__row">
              ...
              <select class="form__input form__input--select <?= getClassError($errors, 'project'); ?>" name="project"
                ...
                <?php endif; ?>
                <?php foreach ($projects as $project): ?>
                  <option value="<?= getValue($project, 'id'); ?>" <?= getSelected(
                       'project',
                       $project['id']
                     ) ?>><?= htmlspecialchars(getValue($project, 'name')); ?></option>
                <?php endforeach; ?>
              </select>
            ...
            <div class="form__row">
              ...
              <input class="form__input form__input--date <?= getClassError($errors, 'date'); ?>" type="text"
                name="date" id="date" value="<?= getPostVal('date'); ?>"
