...
require_once '../php/addProject.php';
session_start();
    ...
    <div class="container container--with-sidebar">
      ...
      <div class="content">
        ...
        <main class="content__main">
          ...
          <form class="form" action="../php/addProject.php" method="post" autocomplete="off">
            <div class="form__row">
              <label class="form__label" for="project_name">Название <sup>*</sup></label>

              <input class="form__input <?= getClassError($errors, 'name'); ?>" type="text" name="name"
                id="project_name" value="<?= trim(getPostVal('name')); ?>" placeholder="Введите название проекта">
